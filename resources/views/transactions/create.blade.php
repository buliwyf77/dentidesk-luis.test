...
@if ($errors->any())
    ...
    <div class="col-md-12 my-3">
            <div class="card">
                <div class="card-header">{{ __('Registro de Transacciones') }}</div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="col-md-7">
                            <input id="desc_transaction" type="text" class="form-control{{ $errors->has('desc_transaction') ? ' is-invalid' : '' }}" name="desc_transaction" value="{{old('desc_transaction')}}"  required data-error="Descripción de Transacción" placeholder="ejemplo: Ingresos por Salario">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="col-md-7">
                            <input id="amount" type="number" class="form-control{{ $errors->has('amount') ? ' is-invalid' : '' }}" name="amount" value="{{old('amount')}}"  data-error="Monto" required placeholder="ejemplo: 150000.00" pattern="[0-9]+([,\.][0-9]+)?" step="0.01">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="col-md-7">
                            <input id="fech_transaction" type="date" class="form-control{{ $errors->has('fech_transaction') ? ' is-invalid' : '' }}" name="fech_transaction" value="{{old('fech_transaction')}}" required  data-error="Fecha de Transacción">
